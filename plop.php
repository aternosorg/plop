...
if (count($argv) <= ARGUMENTS_START) {
    ...
    echo "  --blocks, -b <blocks>        List of blocks to filter for, start your list with ! to disallow this list of blocks." . PHP_EOL;
    exit(1);
}
...
try {
    $plop = new \Aternos\Plop\Plop(
        ...
        blockList: \Aternos\Plop\Placement\BlockList::fromString($options["blocks"])
    );
    $plop->generate();
